...
ERR = "bold #ff3b3b"
WHITE = "bold white"
MUTED = "#9aa89a"   # вторичный текст: светлее DIM, но не спорит с акцентами
FAINT = "#344036"   # дорожки баров, разделители
INK = "#07110a"     # тёмный текст на ярких плашках-бейджах
# Градиент баннера и акцентов: неон → циан → магента
